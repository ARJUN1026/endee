...
/**
 * Update resume metadata (vector indexing, role matches)
 */
export const updateResumeMetadata = async (resumeId, metadata) => {
  try {
    ...
    console.error("Error updating resume metadata:", error.message);
    throw error;
  }
};
