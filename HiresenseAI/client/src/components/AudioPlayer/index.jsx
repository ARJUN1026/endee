...
function AudioPlayer({ audioBase64, autoPlay, onEnded }) {
  ...
  useEffect(() => {
    ...
    if (autoPlay) {
      ...
      audio.play()
        .then(() => console.log("AudioPlayer: Playback started!"))
        .catch((err) => {
          console.error("AudioPlayer: Autoplay failed:", err.message);
          // Only trigger onEnded if the component is still mounted
